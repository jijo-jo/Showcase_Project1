...
import Editwatch from './pages/AdminPages/EditWatches';
import PageforviewAlldelivery from './pages/Delveryboy/Pageforviewalldelivery'
            ...
            <BrowserRouter>
               {localStorage.getItem("Accesstoken") &&<Header />}
                    <Switch>
                        ...
                        <Route exact  path="/deliverypage" component={PageforviewAlldelivery}/>
                        ...
                        <Route exact path="/editwatch/:id" component={Editwatch}/>
